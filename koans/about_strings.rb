...
EOS
  ...
  def test_the_shovel_operator_will_also_append_content_to_a_string
    hi = 'Hello, '
    there = 'World'
    # nest line was the original test but is not compatible with ruby 2.7
    # hi << there
    # change by me to pass test
    hi += there
    assert_equal 'Hello, World', hi
    assert_equal 'World', there
  end
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # I thinks because is similar to add elements to arrays
  end
